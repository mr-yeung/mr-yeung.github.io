...
['SFRNTA==', 'Method of coding that indicates the way the content of a web page will be displayed'],
['SFRUUA==', 'Underlying protocol used by the World Wide Web that defines how messages are formatted and transmitted'],
['RW1haWw=', 'Electronic mail'],
['RlRQ', 'Internet protocol that allows the upload and download of files to and from other computers on a network'],
...
['VVJM', 'Address that defines the route of a web page from a specific server'],
['V1dX', 'World-wide network of sites that can be searched and retrieved by the special protocol known as HTTP']
];
